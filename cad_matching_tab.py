...
# 매칭 알고리즘은 순수 모듈 cad_registration.py 로 분리 (UI 는 래퍼만).
from cad_registration import (
    HAS_PPF,
    cull_model_to_visible,
    load_cad_model,
    cad_match_multi_instance,
    remove_table_plane,
    cluster_scene_dbscan,
    cad_match_per_cluster,
    train_ppf_detector,
    ppf_match_per_cluster,
    ppf_match_whole_scene,
    crop_pointcloud_by_2d_roi,
    object_pose_to_tcp,
